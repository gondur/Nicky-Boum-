...
extern void sys_set_tilemap_data(const uint8 *map_data, const uint8 *anim_lut);
...
extern void sys_play_sfx(const int8 *sample_data, uint32 sample_size, int sample_period);
